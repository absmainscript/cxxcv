...
// New Component: DeveloperContactForm
const DeveloperContactForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("/api/admin/contact-developer", {
        method: "POST",
        headers: {
      ...
      if (response.ok) {
        toast({
          ...
          description: "Sua mensagem foi enviada ao desenvolvedor.",
        });
        setMessage("");
      } else {
        toast({
  ...
  return (
    <Form onSubmit={handleSubmit}>
      <FormField
        ...
        render={() => (
          <FormItem>
            <FormLabel>Mensagem para o Desenvolvedor</FormLabel>
            <FormControl>
              <Textarea
            ...
            <FormDescription>
              Envie uma mensagem diretamente para o desenvolvedor do site.
            </FormDescription>
            <FormMessage />
          </FormItem>
        )}
