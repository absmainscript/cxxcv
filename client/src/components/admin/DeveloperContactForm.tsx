...
import { MessageCircle, Send, Calendar, CheckCircle, AlertTriangle, Trash2, Clock, Eye, HeartHandshake, Bug, Lightbulb, Mail } from "lucide-react";
...
export function DeveloperContactForm() {
  ...
  const form = useForm<SupportMessageForm>({
    ...
    defaultValues: {
      name: "Dra. Adrielle Benhossi",
      email: "escutapsi@adrielle.com.br",
      subject: "",
      message: "",
      type: "support",
    },
    ...
    <div className="space-y-6">
      ...
      <Alert className="bg-gradient-to-r from-blue-50 to-cyan-50 border-blue-200">
        ...
        <AlertDescription className="text-blue-800">
          <strong>📞 Contato Direto:</strong> Rafael Horvan - Desenvolvedor Full Stack<br />
          <strong>📧 Email:</strong> rafaelhorvan@hotmail.com<br />
          <strong>⚡ Resposta:</strong> Geralmente respondo em até 2 horas durante dias úteis!
        </AlertDescription>
      </Alert>
    </div>
  );
