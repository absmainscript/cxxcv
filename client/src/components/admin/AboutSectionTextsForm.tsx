...
export function AboutSectionTextsForm({ configs }: AboutSectionTextsFormProps) {
  ...
  const getAboutData = () => {
    ...
    return {
      ...
      professionalTitle: generalInfo.professionalTitle || "Psicóloga Clínica CRP 08/123456",
  ...
  const updateMutation = useMutation({
    mutationFn: async (data: AboutTextsForm) => {
      // Atualizar nome e título profissional na configuração geral
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>
                  Nome que aparece como título principal na seção sobre
                </FormDescription>
                <FormMessage />
              </FormItem>
            )}
