              ...
              <div className="text-left h-full flex flex-col">
                <div className="flex-1">
                  <div className="inline-block mb-6">
                    <span className={`text-xs font-semibold ${processBadgeWithGradient('', badgeGradient)} bg-purple-100 px-4 py-2 rounded-full tracking-wider uppercase`}>
                      {aboutSection.badge || "SOBRE MIM"}
                    </span>
                  </div>
